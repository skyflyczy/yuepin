...
import com.yp.common.support.ConfigProperties;
import com.yp.common.util.CommonUtil;
...
public class SockIOPool {
	...
	protected void startMaintThread() {
		//是否自动检测memcache
		int memcacheAutoscan =CommonUtil.parseInt(ConfigProperties.getProperty("memcache.autoscan"),-1);
